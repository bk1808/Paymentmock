...
public class CrediCardMock {
	...
	/* this class has been converted into mocking solution jar file since, 
	 * we need to run the jar file in CMD with >> java -jar [drag and drop jar file] click on enter button*/
